<script type="text/javascript">
	function onChange(Obj) {
		...
		if (O_value === "jisen") {
			...
			appends += '<label for="pr" class="col-lg-2 control-label">自己推薦文</label>';
			...
			appends += '<div id="textarea">';
			appends += '<label for="pr" class="col-lg-2 control-label">活動実績</label>';
			appends += '<div class="col-lg-10">'
...
<form class="form-horiontal" method="post" action="send.php" role="form">
	...
	<div class="form-group row ">
		<label for="belong" class="col-lg-2 control-label">大学/学部/学科</label>
		<div class="col-lg-10">
			<input type="text" name="shozoku" class="form-control" id="belong" placeholder="学生大学/理工学部/情報科学科">
		</div>
	</div>
	<div class="form-group row ">
		<label for="grade" class="col-lg-2 control-label">学年</label>
		<div class="col-lg-10">
	...
	<div class="form-group row ">
		<label for="phone" class="col-lg-2 control-label">連絡先(TEL)</label>
		<div class="col-lg-10">
			<input type="tel" name="tel" class="form-control" id="phone" maxlength="15" placeholder="090-0000-0000">
		</div>
	</div>
	<div class="form-group row ">
		<label for="mail" class="col-lg-2 control-label">連絡先(EMAIL)</label>
		<div class="col-lg-10">
	...
	<div class="form-group row margin0-bottom">
		<label for="social" class="col-lg-2 control-label">SNSアカウント(facebook等)</label>
		<div class="col-lg-10">
	...
	<div class="form-group row ">
		<label for="offer" class="col-lg-2 control-label">自薦・他薦</label>
		<div class="col-lg-10">
	...
	<div class="form-group row ">
		<div id="textarea_wrapper">
			<div id="textarea">
				<label for="pr" class="col-lg-2 control-label">自己推薦文</label>
				<div class="col-lg-10">
